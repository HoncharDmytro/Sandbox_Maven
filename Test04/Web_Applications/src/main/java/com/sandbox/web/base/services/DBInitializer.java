...
public class DBInitializer {
    ...
    @Autowired
    private void setSingerService(SingerService singerService) {
    ...
    public void initDB() {
        ...
        singer.setBirthDate(new Date((new GregorianCalendar(1925, 9, 16))
                .getTime()
                .getTime()));
        singerService.save(singer);
        ...
        singer.setBirthDate(new Date((new GregorianCalendar(1942, 11, 27))
                .getTime()
                .getTime()));
        singerService.save(singer);
        ...
        singer.setBirthDate(new Date((new GregorianCalendar(1944, 1, 9))
                .getTime()
                .getTime()));
        singerService.save(singer);
        ...
        singer.setBirthDate(new Date((new GregorianCalendar(1955, 1, 26))
                .getTime()
                .getTime()));
        singerService.save(singer);
        ...
        singer.setBirthDate(new Date((new GregorianCalendar(1965, 7, 23))
                .getTime()
                .getTime()));
        singerService.save(singer);
        ...
        singer.setBirthDate(new Date((new GregorianCalendar(1954, 10, 3))
                .getTime()
                .getTime()));
        singerService.save(singer);
        ...
        singer.setBirthDate(new Date((new GregorianCalendar(1946, 3, 6))
                .getTime()
                .getTime()));
        singerService.save(singer);
        ...
        singer.setBirthDate(new Date((new GregorianCalendar(1992, 11, 18))
                .getTime()
                .getTime()));
        singerService.save(singer);
        ...
        singer.setBirthDate(new Date((new GregorianCalendar(1955, 3, 31))
                .getTime()
                .getTime()));
        singerService.save(singer);
        ...
        singer.setBirthDate(new Date((new GregorianCalendar(1966, 8, 20))
                .getTime()
                .getTime()));
        singerService.save(singer);
        ...
        singer.setBirthDate(new Date((new GregorianCalendar(1947, 7, 20))
                .getTime()
                .getTime()));
        singerService.save(singer);
