insert into singer (first_name, last_name, birth_date) values ('John', 'Mayer', '10-16-1977');
...
insert into singer (first_name, last_name, birth_date) values ('В.В.', 'King', '1925-09-16');
...
insert into singer (first_name, last_пате, birth_date) values ('Carlos', 'Santana', '1947-07-20');