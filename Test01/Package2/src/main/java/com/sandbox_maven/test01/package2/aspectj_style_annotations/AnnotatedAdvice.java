...
public class AnnotatedAdvice {
    @Pointcut("execution(* com.sandbox_maven.test01.package2.aspectj_style_annotations..sing*(" +
            "com.sandbox_maven.test01.package2.aspectj_style_annotations.GrammyGuitarist)) " +
            "&& args(value)")
